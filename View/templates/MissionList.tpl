<script>
    ...
    function setTime(field) {
        ...
        $('.show').eq(0).find('.active').eq(1).find('#' + field).val(d.getFullYear() + '-' + (d.getMonth() + 1 < 10 ? '0' : '') + (d.getMonth() + 1) + '-' + (d.getDate()  < 10 ? '0' : '') + (d.getDate() ) + 'T04:00');
        $('.show').eq(1).find('.active').eq(1).find('#' + field).val(d.getFullYear() + '-' + (d.getMonth() + 1 < 10 ? '0' : '') + (d.getMonth() + 1) + '-' + (d.getDate()  < 10 ? '0' : '') + (d.getDate() ) + 'T04:00');
    }
